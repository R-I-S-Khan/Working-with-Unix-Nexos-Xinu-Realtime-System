...
/* Message constants */
#define SHELL_BANNER  "\033[1;35m ______    _______  ______   _     _  _______  __    _ \n|    _ |  |       ||      | | | _ | ||   _   ||  |  | |\n|   | ||  |    ___||  _    || || || ||  |_|  ||   |_| |\n|   |_||_ |   |___ | | |   ||       ||       ||       |\n|    __  ||    ___|| |_|   ||       ||       ||  _    |\n|   |  | ||   |___ |       ||   _   ||   _   || | |   |\n|___|  |_||_______||______| |__| |__||__| |__||_|  |__|\n \033[0;39m\n"                                                
...
command xsh_semaphore(ushort stdin, ushort stdout, ushort stderr, ushort nargs, char *args[]);
